    ...
    return (
      <div style={{height: "434px", width: "250px", flexDirection: 'row', display: 'flex'}}>
        ...
        <div style={{height:"434px", width: "150px", position: "relative"}}>
          ...
          <div style={{width: "140px", position: "absolute", fontSize: "20px", bottom: "0px", color: 'white', backgroundColor: '#b20000', padding: '5px 0px'}}>Successes</div>
        </div>
        ...
        <div style={{height:"434px", width: "100px", position: "relative"}}>
          ...
          <div style={{width: "90px", position: "absolute", fontSize: "20px", bottom: "0px", color: 'white', backgroundColor: '#b20000', padding: '5px 0px'}}>Errors</div>
        </div>
