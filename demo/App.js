    ...
    return (
      <div style={{height: "434px", width: "250px", flexDirection: 'row', display: 'flex'}}>
        ...
        <div style={{height:"434px", width: "150px", position: "relative"}}>
          <div style={{backgroundColor: 'green', color: 'white', fontSize: "20px", width: "60px", marginLeft: "45px", height: sucHeight, position: "absolute", bottom: "35px"}}>{this.state.suc}</div>
