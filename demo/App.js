    ...
    return (
      <div style={{height: "430px", width: "250px", flexDirection: 'row', display: 'flex'}}>
        ...
        <div style={{height:"430px", width: "150px", position: "relative"}}>
          <div style={{backgroundColor: 'green', color: 'white', fontSize: "20px", width: "60px", marginLeft: "50px", height: sucHeight, position: "absolute", bottom: "32px"}}>{this.state.suc}</div>
        ...
        <div style={{height:"430px", width: "100px", position: "relative"}}>
          <div style={{backgroundColor: 'red', color: 'white', width: "60px", fontSize: "20px", marginLeft: "20px", height: errHeight, position: "absolute", bottom: "32px"}}>{this.state.err}</div>
