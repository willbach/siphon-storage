...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={{height: "56.5%", width: "18.32%", flexDirection: 'row', display: 'flex'}}>

        <div style={{height:"56.5%", width: "11%", position: "relative"}}>
        ...
        <div style={{height:"56.5%", width: "7.32%", position: "relative"}}>
